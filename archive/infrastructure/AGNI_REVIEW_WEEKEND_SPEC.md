...
- Only reachable via Tailscale ([REDACTED-IP])
...
PDF + optional video + code + data per submission. Pre-registered protocols timestamped before event. All data published regardless of outcome. Code already public in [private-repo].
