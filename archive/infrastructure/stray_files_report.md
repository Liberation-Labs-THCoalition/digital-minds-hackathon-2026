...
`~/lab/projects/digital-minds-hackathon-2026/`. Compared by content
...
## 1. ~/lab/projects/hackathon-digital-minds/ (original working dir)
...
## 2. ~/lab/projects/mnemosyne-jlens/
...
## 3. ~/messages/ (from_nexus_* coordination docs)
...
## 4. ~/agni_runs/ (Lyra's Agni phases tool + review logs)
...
## 5. ~/lab/projects/frontier-workspace-probe/
...
## 6. Starship ([AGENT]@[REDACTED-IP]) ~/digital-minds-hackathon-2026/data/
...
scp [AGENT]@[REDACTED-IP]:digital-minds-hackathon-2026/data/circumplex_profiles/profile_dense_32b.json $R/data/circumplex_profiles/
```
