...
LOG=/home/admin/lab/projects/hackathon-digital-minds/hackathon_launch.log
...
cd /home/admin/lab/projects/mnemosyne-jlens
/home/admin/lab/mechinterp-env/bin/modal run modal_moe_jlens_conditioned.py >> "$LOG" 2>&1 &
MODAL_PID=$!
...
ssh margaret@100.69.191.67 "export PATH=/usr/local/bin:/opt/homebrew/bin:\$PATH; \
