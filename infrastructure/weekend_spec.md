...
Kill Ayni MLX server (~17GB) before loading any second model: `ssh margaret@100.69.191.67 "kill $(pgrep -f 'mlx_lm.*8090')"`
...
2. Code: the metacognitive module (already public in Project-Mnemosyne)
...
|------|-----------|--------|------------|
| Starship OOM | Medium | Blocks experiments | Model loading choreography (Section 3). Kill Ayni MLX before loading second model. Pre-flight: `ssh margaret@100.69.191.67 'vm_stat'` |
