...
## Status — updated Aug 16 ~19:00. All 5 cleared and shipped.
...
`mnemosyne/variable_landing.py`). No video built for this track.
...
MoE and metacognitive memory; `af_nicole` (warmer, more contemplative) on Butlin,
circumplex, and Ghost Dimensions.
