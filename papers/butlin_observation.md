...
**Blind scoring:** An earlier draft cited "Berg / Reciprocal Research (2025-2026)" as a validated precedent for blind-scoring Butlin indicators across biological and artificial systems; this citation could not be verified against any findable publication (flagged in `archive/infrastructure/citation_gaps.md` #2, confirmed on recheck) and has been removed. Cameron Berg (AE Studio) has published relevant but methodologically distinct work — self-referential processing eliciting experience reports (Berg, de Lucena & Rosenblatt, 2025, arXiv:2510.24797) and an informal position piece on evidence for AI consciousness (Berg, 2025, *AI Frontiers*) — neither describing a blind multi-evaluator scoring study. To our knowledge, the blind dual-substrate design below is original to this study.
...
Berg, C. (2025). The Evidence for AI Consciousness, Today. AI Frontiers, December 8, 2025.
